...
Pour finir, Victorien s'est occupé de rédiger ce rapport et de faire le schéma de l'architecture. Par contre, pour trouver les problèmes du début et les solutions (comme le découpage en couches), on a tous réfléchi ensemble pour se mettre d'accord.
